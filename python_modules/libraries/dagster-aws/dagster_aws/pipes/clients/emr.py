...
class PipesEMRClient(PipesClient, TreatAsResourceParam):
    ...
    def _enrich_params(
        ...
        for key, value in session.default_remote_invocation_tags.items():
    ...
    def _read_messages(self, context: OpExecutionContext, response: "RunJobFlowOutputTypeDef"):
